  ...
  return (
    <div className="relative bg-black">
      ...
      <ScrollExpand
        ...
        useWindowScroll
      >
        {/* Content revealed after the frame fully expands */}
        <div className="relative z-20 bg-[#060b08] overflow-hidden">

          {/* Floating Parallax Vector Tea Leaves */}
          <div className="absolute top-[10%] left-[5%] pointer-events-none z-10 opacity-20 hidden lg:block">
          ...
          <div className="absolute top-[40%] right-[6%] pointer-events-none z-10 opacity-15 hidden lg:block">
          ...
          {/* Gradient transition from transparent to solid */}
          <div className="h-32 bg-gradient-to-b from-transparent to-[#060b08]" />
          ...
          <section className="px-6 md:px-16 lg:px-24 pt-16 pb-24 max-w-6xl mx-auto text-center">
            ...
            <h2 className="text-white text-4xl md:text-6xl lg:text-7xl font-bold uppercase tracking-tight leading-[1.1] mb-8">
              Where Every Leaf<br />
            ...
            <div className="w-16 h-[1px] bg-[#8bb56e]/40 mx-auto mt-12" />
          </section>

          {/* ── Secondary ScrollExpand showcase (fixed height) ── */}
          <section className="px-6 md:px-16 lg:px-24 pb-16 max-w-6xl mx-auto">
            <p className="text-[#8bb56e] text-xs font-mono tracking-[0.35em] uppercase mb-8 text-center">
              The Harvest
            </p>
          ...
          <section className="px-6 md:px-16 lg:px-24 pb-32 max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              ...
              <div className="group p-8 md:p-10 rounded-2xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-all duration-500">
                <div className="w-12 h-12 rounded-full border border-[#8bb56e]/30 flex items-center justify-center mb-6 group-hover:border-[#8bb56e] transition-colors duration-500">
          ...
          {/* ── Philosophy Quote ── */}
          <section className="px-6 md:px-16 lg:px-24 py-28 max-w-4xl mx-auto text-center border-t border-b border-white/5">
            <svg viewBox="0 0 24 24" className="w-8 h-8 text-[#8bb56e]/30 mx-auto mb-8" fill="currentColor">
              <path d="M6 17h3l2-4V7H5v6h3zm8 0h3l2-4V7h-6v6h3z" />
            </svg>
            <blockquote className="text-white/70 text-xl md:text-2xl lg:text-3xl font-light italic leading-relaxed mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div key={stat.label}>
                  ...
                  <p className="text-white/30 text-[11px] font-mono tracking-widest uppercase mt-2">{stat.label}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          {/* ── Footer ── */}
          <footer className="px-6 md:px-16 lg:px-24 py-16 border-t border-white/5 max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60 text-sm font-bold uppercase tracking-tight">
                  Elegant Sip
                </span>
              </div>
