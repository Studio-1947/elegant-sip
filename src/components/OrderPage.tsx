      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white border border-[#1b261b]/10 rounded-2xl p-6 md:p-8 mb-6">
          ...
          <div className="space-y-2.5 text-xs">
            ...
            {order.discount > 0 && (
              <div className="flex justify-between text-[#4a7333]"><span>Discount{order.coupon ? ` (${order.coupon})` : ''}</span><span className="font-mono">−{formatINR(order.discount)}</span></div>
            )}
