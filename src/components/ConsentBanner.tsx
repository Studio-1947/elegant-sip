  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3">
        <button
          onClick={() => choose(true)}
          className="flex-grow bg-[#1b261b] hover:bg-[#2b3a2b] text-white text-[10px] font-bold tracking-widest uppercase py-2.5 px-4 rounded-lg transition-colors cursor-pointer"
        >
          Accept
        </button>
        <button
          onClick={() => choose(false)}
          className="flex-grow border border-[#1b261b]/20 hover:border-[#1b261b] text-[#1b261b] text-[10px] font-bold tracking-widest uppercase py-2.5 px-4 rounded-lg transition-all cursor-pointer"
        >
          Decline
        </button>
      </div>
