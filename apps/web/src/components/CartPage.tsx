  ...
  return (
    <div className="min-h-screen bg-[#f9faf7] text-[#1b261b] font-sans pt-32 pb-24 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-6xl mx-auto mb-12 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <Link to="/" className="group flex items-center gap-2 text-xs font-mono tracking-widest uppercase text-[#4a584a] hover:text-[#4a7333] transition-colors mb-4">
        ...
        <p className="text-xs font-mono text-[#4a7333] uppercase tracking-[0.2em] border border-[#8bb56e]/20 rounded-full px-4 py-2 bg-[#8bb56e]/5 self-start md:self-auto">
          Secure Checkout
        </p>
      </div>
      ...
      {cart.length === 0 ? (
        <div className="max-w-md mx-auto text-center py-20 px-6 bg-white border border-[#1b261b]/10 rounded-2xl shadow-[0_12px_40px_rgba(27,38,27,0.04)]">
          <svg viewBox="0 0 24 24" className="w-16 h-16 text-[#4a7333]/40 mx-auto mb-6" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white border border-[#1b261b]/10 rounded-2xl p-6">
              <label htmlFor="order-notes" className="block text-[11px] font-mono tracking-widest uppercase text-[#4a584a] mb-2">
              ...
              <textarea
                ...
                className="w-full bg-[#f9faf7] border border-[#1b261b]/15 rounded-lg px-4 py-3 text-sm focus:border-[#8bb56e] transition-colors placeholder:text-[#1b261b]/25 resize-none"
              />
            </div>
          </div>
          ...
          <div className="bg-white border border-[#1b261b]/10 rounded-2xl p-6 md:p-8 shadow-[0_12px_40px_rgba(27,38,27,0.04)] lg:sticky lg:top-28">
            ...
            {/* Coupon */}
            <div className="mb-6">
              <label htmlFor="coupon" className="block text-[11px] font-mono tracking-widest uppercase text-[#4a584a] mb-2">
                Promo Code
              </label>
              {coupon ? (
                <div className="flex items-center justify-between bg-[#8bb56e]/5 border border-[#8bb56e]/30 rounded-lg px-4 py-2.5">
                  <span className="text-xs font-mono font-bold text-[#4a7333]">{coupon} applied</span>
                  <button onClick={removeCoupon} className="text-[11px] font-mono uppercase tracking-wider text-[#4a584a] hover:text-red-600 transition-colors cursor-pointer">
                    Remove
                  </button>
                </div>
              ) : (
            ...
            <div className="space-y-4 text-xs">
              ...
              {shippingFee > 0 && (
                <p className="text-[11px] text-[#4a7333] font-mono italic">
