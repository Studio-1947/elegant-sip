...
export default function NotFoundPage() {
  useDocumentMeta('Page Not Found | Elegant Sip', 'The page you were looking for could not be found.', { noindex: true })

  return (
    <div className="min-h-screen bg-[#f9faf7] text-[#1b261b] font-sans pt-40 pb-24 px-6 flex items-start justify-center">
      <div className="max-w-lg mx-auto text-center">
        <span className="text-[#4a7333] text-xs font-mono tracking-[0.3em] uppercase block mb-5">404</span>
        <h1 className="text-4xl md:text-6xl font-bold uppercase tracking-tight leading-[1.05] mb-6">
          This leaf has <span className="text-[#4a7333]">drifted away</span>
        </h1>
